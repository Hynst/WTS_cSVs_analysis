...
No need for instalation
   ...
   3) Please name files prefix in each folder consistently ie. {S1_}eric_results.tsv, {S2_}jaffa_results.tsv,     {S3_}fc_results.tsv
   <br /> !!! here "_" is important for sample name recognition !!!
